...
constexpr double DEFAULT_PRICE = 999.99;
constexpr int DEFAULT_STOCK = 10;
constexpr int DEFAULT_ID = 101;
...
void Article::printInfo() const 
{
    ...
    std::cout << "Price: " << std::fixed << std::setprecision(2) << this->price << std::endl;
...
int main() 
{
    Article article ("Laptop", DEFAULT_PRICE, DEFAULT_STOCK, "Electronics", DEFAULT_ID);
